// data/services.ts : Driveway Gates Surrey
...
export const services: Service[] = [
  {
    ...
    description: 'The practical choice for driveways where swing clearance is limited. Sliding gates run on a ground track or cantilever system and handle wide openings, sloped approaches, and compact plots that swing gates cannot serve.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes, and Surrey driveways frequently require this solution. The county has a significant number of properties on sloped plots, particularly in the North Downs, the Surrey Hills, and on the hillside streets of Guildford, Reigate, and Dorking. The track itself must be level regardless of the driveway gradient, which means the installer builds up the track foundation on a slope or specifies a cantilever system that clears the ground entirely. Both solutions are well-established. Bring photographs of your driveway to the site survey so the installer can assess the gradient before visiting.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'In the majority of cases, no. Permitted development rights cover gates up to 2 metres in height that open inward and are not adjacent to a classified road. The limit drops to 1 metre for gates that front a highway. Listed buildings and conservation area properties require consent regardless of height. Surrey has a high concentration of planning designations: the Surrey Hills AONB, extensive Green Belt coverage, and conservation areas in every district town and dozens of villages. Your installer will flag any planning considerations at the site survey stage and can recommend a pre-application enquiry to the local authority where there is any doubt.',
      },
    ],
  },
  {
    ...
    description: 'Bespoke hardwood gates crafted to specification in iroko, European oak, or Accoya. The natural choice for period properties, barn conversions, Surrey Hills homes, and rural plots where character matters as much as security.',
    image: '/images/gates/gate-wooden-painted-cream-roses-surrey-hills.png',
    icon: 'Sparkles',
    color: 'amber',
    faqs: [
      {
        question: 'How long do hardwood driveway gates last in Surrey?',
        answer: 'A properly specified and maintained hardwood gate will outlast almost any other material. Iroko, the most widely used species for Surrey residential gates, has a natural oil content that resists moisture absorption and holds its shape reliably through the seasonal weather changes the county experiences. With an oil treatment every two years, an iroko gate will remain structurally sound and presentable for 25 to 30 years. European oak performs similarly and weathers to an attractive silver-grey if left untreated. Accoya, a modified radiata pine with a 50-year above-ground durability guarantee, is the low-maintenance premium option for exposed rural positions.',
      },
      {
      ...
      {
        question: 'Which timber species works best for Surrey conditions?',
        answer: 'Iroko is the most reliable all-round choice for Surrey residential gates. It is naturally durable to Use Class 3 without treatment, resists surface checking in hot dry summers, and holds its shape through damp winters. European oak is equally durable and preferred where the grain and character of the timber are a design priority, and it is often the appropriate choice in Surrey Hills AONB and conservation area contexts where the material authenticity matters. Accoya is the right choice for homeowners who want a documented 50-year lifespan with minimal annual maintenance, particularly on exposed rural properties in the Surrey Hills where weather cycles are more pronounced.',
      },
    ],
  },
  {
    ...
    description: 'Fabricated steel, aluminium, and wrought iron gates built to last. From hand-forged ornate ironwork on Surrey estate properties to precision-cut contemporary aluminium on modern commuter belt builds.',
    ...
    faqs: [
      {
        ...
        answer: 'Mild steel is the standard fabrication material for bespoke gates across Surrey. It is strong, weldable into any profile, and takes a hot-dip galvanised and powder-coated finish that protects against rust for 20 years or more. Aluminium is lighter than steel, will not rust under any conditions, and is the preferred choice for very wide gates or heavy automation where reducing the moving weight extends motor life. Wrought iron is a specialist material, hand-forged by blacksmiths rather than fabricated, and is used on high-value period and estate properties where the authentic texture and character of the material justify the additional cost. Surrey is one of the strongest markets for wrought iron residential gates in the country, particularly in the Weybridge, Cobham, Esher, and Reigate areas.',
      },
      {
        question: 'Do metal gates rust in Surrey conditions?',
        answer: 'Untreated steel and iron will corrode in Surrey conditions over time. The correct specification is hot-dip galvanising before powder coating, which encases the steel in zinc before the polymer finish is applied. This two-stage protection means that any chip or scratch in the powder coat exposes zinc rather than steel, and the zinc continues to protect through a sacrificial mechanism. A gate specified this way should not require remedial rust treatment for 20 years or more in Surrey conditions. Aluminium is the sensible alternative where longevity with zero rust risk is the priority, as it forms a stable oxide layer that protects the metal without any additional treatment.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Once a year is the minimum for any automated gate system. A full service covers motor lubrication, gearbox inspection, drive belt or rack-and-pinion condition, hinge torque, safety sensor alignment and sensitivity testing, battery backup charge level, intercom function, and a visual inspection of the gate structure, posts, and finish. Annual servicing typically costs £130 to £220 in Surrey and will extend the working life of the motor by several years. It also keeps the manufacturer warranty valid on systems still within the warranty period.',
      },
      {
